...
-- CreateEnum
CREATE TYPE "MembershipTier" AS ENUM ('STANDARD', 'GOLD', 'ELITE');

-- CreateEnum
CREATE TYPE "ProductCategory" AS ENUM ('PERFUMES', 'WATCHES', 'BAGS', 'ACCESSORIES');

-- CreateEnum
CREATE TYPE "ProductBrand" AS ENUM ('UNIQUE_DIAMOND', 'ORAD', 'TARAF_COLLECTION');

-- CreateEnum
CREATE TYPE "BadgeVariant" AS ENUM ('PRIMARY', 'SECONDARY');
...
-- CreateEnum
CREATE TYPE "AddressIcon" AS ENUM ('HOME', 'WORK');
...
CREATE TABLE "Address" (
    ...
    "userId" TEXT NOT NULL,
    "label" TEXT NOT NULL,
    "icon" "AddressIcon" NOT NULL DEFAULT 'HOME',
    "line1" TEXT NOT NULL,
    "line2" TEXT,
    "city" TEXT NOT NULL,
...
CREATE TABLE "HomeContent" (
    ...
    "hero" JSONB NOT NULL,
    "bentoItems" JSONB NOT NULL,
    "featuredCollectionIds" TEXT[] DEFAULT ARRAY[]::TEXT[],
